...
userName.
    ...
    public void setUserName(String userName) {
        ...
        if (userName.length()>6) {
            ...
            System.out.println("Invalid username. Username should not be empty" +
    ...
    public void setPassword(String password) {
        ...
        if (password.length()>6 && !password.contains(userName)) {
            ...
            System.out.println("Invalid password. Password should not be empty," +
                    " should be at least 6 characters long, and should not contain the username.");
        }
    }
